...
Revision ID: 75e5e1475ba3
Revises: 
Create Date: 2025-01-22 21:56:50.960922
...
def downgrade() -> None:
    ...
    sa.Column('google_token', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('google_refresh_token', sa.VARCHAR(), autoincrement=False, nullable=True),
